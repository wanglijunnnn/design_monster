  ...
  <div class="canvas-tool">
    ...
    <div class="add-element-handler">
      ...
      <div  @click="showModal">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="插入模板">
          <IconViewGirdDetail class="handler-item"/>
        </Tooltip>
      </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const mubanPoolVisible = ref(false)
    ...
    const showModal = (line: LinePoolItem) => {
      mubanPoolVisible.value = true
    }
    
    const handleOk = (line: LinePoolItem) => {
      mubanPoolVisible.value = false
    }
    return {
      scaleCanvas,
      setCanvasPercentage,
